...
{
    // Eğer model değişmişse veri tabanını oluştur
    public class DataInitializer:DropCreateDatabaseIfModelChanges<DataContext>
    {
        // Seed metoduyla test verilerini ekleyelim

        protected override void Seed(DataContext context)
        {
            // Category listesinde kategoriler adında liste türetiyoruz
            ...
            // foreach açarak context in üzerine yolladığımız
            // category den kategori yi türetiyoruz
            // yani kategoriler olarak oluşturduğumuz listeyi
            // context teki category listesine gönderiyoruz
            ...
            // kategoriler için yaptığımız işlemi ürünler için yapıyoruz
            var urunler = new List<Product>()
            {
                ...
                new Product(){ Name = "LG 49UH610V 49 124 Ekran 4K Uydu Alıcılı Smart LED TV", Price =1200 , Stock =500 , IsApproved =true , CategoryId = 3,Image="3.jpg"},
                ...
                new Product(){ Name = "Apple iPhone 6 32 GB (Apple Türkiye Garantili)", Price =1200 , Stock =500 , IsApproved =true , CategoryId = 4,Image="4.jpg"},
